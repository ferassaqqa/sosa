...
<div class="modal-body">
    <table class="table table-responsive table-bordered">
        ...
        <tbody>
            <tr>
                <td>{{ $circle->book_name }}</td>
                <td>{{ $users->count() }}</td>
                {{-- <td>{!! $circle->book_students_category_string !!}</td> --}}
            </tr>
        </tbody>
    </table>
    <table class="table table-responsive">
        <thead>
            ...
            @if(hasPermissionHelper('حذف بيانات الطالب'))
                <th>حذف</th>
            @endif
        </thead>
        <tbody>
            ...
            @foreach($users as $key => $user)
                @if($user)
                    <tr>
                        ...
                        {{-- <td>{!! in_array($user->student_category,$circle->student_categories) ? '<i class="mdi mdi-checkbox-marked-circle-outline" style="color:green"></i>' : '<i class="mdi mdi-close-circle-outline" style="color:red"></i>' !!}</td> --}}
                        @if(hasPermissionHelper('حذف بيانات الطالب'))
                            <td>{!! $user->deleteCircleStudent($circle->id) !!}</td>
                        @endif
                    </tr>
                    @php $i++; @endphp
                @endif
...
<script>
    function deleteCircleStudent (obj){
    ...
    function showCircleStudent(circle_id) {
