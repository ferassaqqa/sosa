...
<div class="modal-header">
    <h5 class="modal-title" id="myLargeModalLabel" style="color: #000 !important;">  التقارير الشهرية لحلقة {{ $user->name }}  </h5>
...
<script>
    $(document).ready(function() {
        var table1 = $('#dataTable1').DataTable( {
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('circleMonthlyReports.getTeacherMonthlyReportsData',$user->id) }}",
            language: {
                search: "بحث",
            ...
            Swal.fire({
                ...
                preConfirm: function(value){
                    ...
                    if(date && date.value != '') {
                        ...
                        return fetch('/createCircleMonthlyReports/{{$user->current_circle ? $user->current_circle->id : 0}}/' + date.value)
