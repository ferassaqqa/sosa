    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" class="form-control" name="name" disabled value="{{ $user->name }}" style="width: 86%;display: inline-block;">
            </td>
        ...
        <tr>
            ...
            <td colspan="2">
                {{--{{ $user->id_num }}--}}
                <input type="number" min="1" style="direction: rtl;" step="1" class="form-control" name="id_num" value="{{ $user->id_num }}">
            </td>
        </tr>
        <tr>
            ...
            <td colspan="6">
                ...
                <select class="form-control" name="role_id" id="role_id">
                    ...
                    @foreach($roles as $key => $value)
                        <option value="{{ $value->name }}" @if($value->users_count) selected @endif>{{ $value->name }}</option>
                    @endforeach
                </select>
            </td>
        </tr>
