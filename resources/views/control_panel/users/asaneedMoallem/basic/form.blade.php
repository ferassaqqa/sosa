...
<div class="row mb-5">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td colspan="2">
                <input type="number" disabled class="form-control" step="1" min="1" name="sons_count" value="{{ $user->sons_count }}" style="direction: rtl;">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <input type="text" class="form-control" placeholder="قيمة الكفالة"
                       name="contract_type_value" value="{{old('contract_type_value',isset($user->userExtraData) ? $user->userExtraData->contract_type_value : '' )}}" >
            </td>
        </tr>
    </table>
</div>
...
@if(isset($duplicated) && $duplicated == 1)
    <input type="hidden" name="duplicated" value="{{ $duplicated }}">
@endif
<script>
