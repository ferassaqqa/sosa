...
<div class="modal-header">
    <h5 class="modal-title" id="myLargeModalLabel" style="color: #000 !important;">اضافة معلم جديد</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form action="{{ route('moallem.store') }}" method="POST" id="form" enctype="multipart/form-data">
        @include('control_panel.users.moallem.basic.form')
    </form>
</div>
