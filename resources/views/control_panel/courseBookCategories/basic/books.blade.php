...
<div class="modal-header">
    <h5 class="modal-title" id="myLargeModalLabel" style="color: #000 !important;"> كتب ضمن التصنيف - {{ $CourseBookCategory->name }} -</h5>
...
<div class="modal-body">
    <table class="table table-responsive table-bordered">
        ...
        <tbody>
        @foreach($CourseBookCategory->books as $book)
            <tr>
                <td>{{ $book->name }}</td>
                <td>{{ $book->author }}</td>
