...
@section('script')
    <script>
        ...
        function updateCourseAndStudentsStatisticsInDashboard() {
            var filters = '?dashboard_area_id='+$('#dashboard_area_id').val()+'&dashboard_sub_areas_select='+$('#dashboard_sub_areas_select').val()+'&is_accepted='+$('#is_accepted').val()+'&status='+$('#dashboard_courses_status').val();
