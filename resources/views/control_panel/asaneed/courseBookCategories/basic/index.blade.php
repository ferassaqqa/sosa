...
@endsection
@section('title')
    <title>برنامج السنة | تصنيفات كتب الأسانيد والإجازات </title>
@endsection
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"> تصنيفات كتب الأسانيد والإجازات</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">الرئيسية</a></li>
                    <li class="breadcrumb-item active"> تصنيفات كتب الأسانيد والإجازات</li>
                </ol>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-3">
                        <button type="button" class="btn btn-info call-modal" data-url="{{route('asaneedBookCategories.create')}}" style="width: 305px;"
    ...
    <script>
        var table = ''; $(document).ready(function() {
            table = $('#dataTable').DataTable( {
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('asaneedBookCategories.getData') }}",
                language: {
                    search: "بحث",
