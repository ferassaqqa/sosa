...
<div class="modal-header">
    <h5 class="modal-title" id="myLargeModalLabel" style="color: #000 !important;">اضافة دورة علمية جديدة</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form action="{{ route('asaneedBookCategories.store') }}" method="POST" id="form">
        @include('control_panel.asaneed.courseBookCategories.basic.form')
    </form>
</div>
