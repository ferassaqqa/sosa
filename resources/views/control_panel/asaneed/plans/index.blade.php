...
@endsection
@section('title')
    <title>برنامج السنة | تحليل الخطة والانجازات في الأسانيد والإجازات</title>
@endsection
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">تحليل الخطة والانجازات في الأسانيد والإجازات</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">الرئيسية</a></li>
                    <li class="breadcrumb-item active">تحليل الخطة والانجازات في الأسانيد والإجازات</li>
                </ol>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-3">
                        <button class="btn btn-primary" onclick="createNewPlan('{{route('asaneedPlans.create')}}')" style="width: 305px;">
                ...
                <div class="">
                    <table class="table table-centered table-nowrap mb-0 table-bordered" id="dataTable" style="display: inline-table;">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#dataTable').DataTable( {
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('asaneedPlans.getData') }}",
                language: {
                    search: "بحث",
        ...
        function getYearDataAnalysis(year,department) {
            ...
            $.get('/areaAsaneedCoursesProgressPercentage/'+year+'/'+department,function (data) {
                $('.bs-example-modal-xl').modal('show');
