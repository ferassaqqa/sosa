...
<div class="modal-header">
    <h5 class="modal-title" id="myLargeModalLabel" style="color: #000 !important;"> تعديل بيانات كتاب {{ $asaneedBook->name }} </h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form action="{{ route('asaneedBooks.update',$asaneedBook->id) }}" method="POST" id="form">
        <input type="hidden" name="_method" value="PUT">
        @include('control_panel.asaneed.books.basic.form')
    </form>
</div>
