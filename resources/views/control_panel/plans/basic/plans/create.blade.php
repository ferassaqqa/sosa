...
<div class="modal-header">
    <h5 class="modal-title" id="myLargeModalLabel" style="color: #000 !important;"> اضافة خطة سنوية جديدة {{$department_name}}</h5>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form action="{{ route('plans.store') }}" method="POST" id="form">
        @include('control_panel.plans.basic.plans.form')
    </form>
</div>
...
<script>
    ...
    //         //     return fetch('/plans/plan/create/'+value)
