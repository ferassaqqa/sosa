...
class newRoleReuest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        ...
        if($role) {
//            dd(hasPermissionHelper('تصفح بيانات دور محذوف'));
            if (!hasPermissionHelper('تصفح بيانات دور محذوف')) {
                return [
                ...
                return [
                    'name.required' => 'يرجى ادخال قيمة',
                    'name.string' => 'يجب ان تكون قيمة حقيقية',
                    'name.unique' => $this->name . ' قيمة موجودة مسبقا يرجى ادخال قيمة مختلفة او اضغط ' . $restore_link . ' لاستعراض بياناته ',
                ];
            }
        }else{
