...
class updateCircleBookRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name'=>'required|string|unique:circle_books,name,'.$this->id,
            'hadith_count'=>'required|numeric',
            'pass_mark'=>'required|numeric',
            'book_code'=>'required|string|unique:circle_books,name,'.$this->id,
        ];
    }
