...
namespace App\Http\Requests\controlPanel\users\moallem;

use App\Models\User;
use Illuminate\Foundation\Http\FormRequest;

class newMoallemRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if($old_user&&$old_user->hasRole('معلم')){
            $idNumRule = 'required|numeric|unique:users,id_num';
        }else{
            $idNumRule = 'required|numeric';
        }
        return [
...
//            'material_status.in'=>'أعزب أو مطلق أو متزوج',
            ...
            'join_date.date_format'=>'صيغة تاريخ الميلاد سنة - شهر - يوم',
