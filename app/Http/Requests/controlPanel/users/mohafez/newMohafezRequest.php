...
namespace App\Http\Requests\controlPanel\users\mohafez;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Str;

class newMohafezRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'id_num'=>'required|numeric|unique:users,id_num',
...
//            'material_status.in'=>'أعزب أو مطلق أو متزوج',
            ...
            'fb_link.string'=>'يرجى ادخال رابط صحيح',
