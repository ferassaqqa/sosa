...
class User extends Authenticatable
{
    ...
    public function getMostAccomplishedAsaneedRowDataAttribute()
    {
        ...
        $teacher_courses = $this->teacherAsaneedCourses;
        foreach ($teacher_courses as $key => $course) {
            $total += $course->students->count();
        }
        ...
        $most_accomplished =  DB::table('asaneed_course_students')
            ...
            ->where('asaneed_courses.teacher_id', '=', $this->id)
    ...
    public function scopeDepartment($query, $department)
    {
        switch ($department) {
            case 0: {
                ...
                break;
            case 1: {
                    return $query->role('محفظ');
                }
                break;
            case 2: {
                    return $query->role('معلم');
                }
                break;
            case 3: {
                    return $query->role('طالب تحفيظ');
                }
                break;
            case 4: {
                    return $query->role('طالب دورات علمية');
                }
                break;
            case 5: {
                    return $query->role('مشرف جودة');
                }
                break;
            case 6: {
                    return $query->role('مشرف ميداني');
                }
                break;
            case 7: {
                    return $query->role('شيخ اسناد');
                }
                break;
            case 8: {
                    return $query->role('طالب دورات أسانيد وإجازات');
                }
                break;
        }
    }
